...
function SkillsSection({ coreSkills }: { coreSkills: ResumeContent["coreSkills"] }) {
  const [ref, visible] = useIntersectionVisible();
...
export function ResumeClient({
  ...
  const { summary, coreSkills, techTags, experience, certifications, education } = content;
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Email dialog */}
      {emailDialogOpen && <EmailDialog onClose={() => setEmailDialogOpen(false)} />}
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 py-14 sm:py-20">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-7">
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                <h1 id="resume-hero-name" className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight leading-none">
                  Steve Ackley
                </h1>
            ...
            >
              <div className="flex flex-col gap-2">
                <a
                  href="/steve-ackley-resume.pdf"
                  download="Steve-Ackley-Resume.pdf"
                ...
                <p className="text-xs text-blue-200 text-center">Downloads clean PDF</p>
              </div>
            </div>
