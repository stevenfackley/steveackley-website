...
const $$Edit = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const updateAction = async (formData) => {
    formData.set("id", id);
    return await actions.updatePost(formData);
  };
...
</a> <h1 class="text-3xl font-extrabold tracking-tight text-[var(--text-primary)] mt-4">Edit Post</h1> </div> ${renderComponent($$result2, "PostForm", PostForm, { "client:load": true, "action": updateAction, "defaultValues": {
    title: post.title,
