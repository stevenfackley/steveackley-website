import { v as ROUTE_TYPE_HEADER, w as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, x as ActionNotFoundError, y as clientAddressSymbol, z as LocalsNotAnObject, B as FailedToFindPageMapSSR, C as REROUTABLE_STATUS_CODES, G as responseSentSymbol, H as nodeRequestAbortControllerCleanupSymbol } from './astro/server_B-1XR7Cx.mjs';
import colors from 'piccolore';
import 'clsx';
import { D as DEFAULT_404_ROUTE, e as default404Instance, f as ensure404Route } from './astro-designed-error-pages_BrOPlBF3.mjs';
...
import { r as requestIs404Or500, i as isRequestServerIsland, n as notFound, b as normalizeTheLocale, c as redirectToFallback, e as redirectToDefaultLocale, f as requestHasLocale, d as defineMiddleware, S as SERVER_ISLAND_COMPONENT, h as SERVER_ISLAND_ROUTE, j as createEndpoint, R as RouteCache, s as sequence, k as findRouteToRewrite, v as validateAndDecodePathname, m as matchRoute, l as RenderContext, P as PERSIST_SYMBOL, o as getSetCookiesFromResponse } from './index_T92e_VwJ.mjs';
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_DLvjjbt7.mjs';
