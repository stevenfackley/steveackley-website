...
import { c as cn } from './utils_CPMI-xBA.mjs';
import { I as ImageUploadButton } from './PostForm_Cf5QOab9.mjs';
...
var Portals = ({ contentComponent }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment$1, { children: Object.values(renderers) });
};
...
function PostEditor({ value, onChange }) {
  const editor = useEditor({
    extensions: [
      ...
      index_default$3.configure({ openOnClick: false, HTMLAttributes: { rel: "noopener noreferrer" } }),
      index_default.configure({ placeholder: "Start writing your post..." })
    ],
    content: value,
  ...
  const addImage = (url) => editor?.chain().focus().setImage({ src: url }).run();
  const btn = (active) => cn("px-2 py-1 text-xs rounded font-medium transition-colors", active ? "bg-[var(--accent)] text-white" : "bg-[var(--surface-hover)] text-[var(--text-secondary)] hover:text-[var(--text-primary)]");
  if (!editor) return null;
  return /* @__PURE__ */ jsxs("div", { className: "border border-[var(--border)] rounded-2xl overflow-hidden bg-[var(--surface)]", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1 p-3 border-b border-[var(--border)] bg-[var(--surface-hover)]", children: [
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("bold")), onClick: () => editor.chain().focus().toggleBold().run(), children: "B" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("italic")), onClick: () => editor.chain().focus().toggleItalic().run(), children: "I" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("code")), onClick: () => editor.chain().focus().toggleCode().run(), children: "<>" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("heading", { level: 2 })), onClick: () => editor.chain().focus().toggleHeading({ level: 2 }).run(), children: "H2" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("heading", { level: 3 })), onClick: () => editor.chain().focus().toggleHeading({ level: 3 }).run(), children: "H3" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("bulletList")), onClick: () => editor.chain().focus().toggleBulletList().run(), children: "• List" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("orderedList")), onClick: () => editor.chain().focus().toggleOrderedList().run(), children: "1. List" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("blockquote")), onClick: () => editor.chain().focus().toggleBlockquote().run(), children: "❝" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(editor.isActive("codeBlock")), onClick: () => editor.chain().focus().toggleCodeBlock().run(), children: "Code" }),
      /* @__PURE__ */ jsx("button", { type: "button", className: btn(false), onClick: () => {
        const url = window.prompt("URL:");
        if (url) editor.chain().focus().setLink({ href: url }).run();
      }, children: "Link" }),
      /* @__PURE__ */ jsx(ImageUploadButton, { onUpload: addImage })
    ] }),
    /* @__PURE__ */ jsx(EditorContent, { editor, className: "min-h-[400px] p-4 prose prose-neutral dark:prose-invert max-w-none text-[var(--text-primary)]" })
  ] });
}
